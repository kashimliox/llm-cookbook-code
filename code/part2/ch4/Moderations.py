...
from openai.types import moderation_create_params
...
from openai.types.moderation_model import ModerationModel
from openai.types.moderation_create_response import ModerationCreateResponse
from openai.types.moderation_multi_modal_input_param import ModerationMultiModalInputParam
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "https://dashscope.aliyuncs.com/green/text/scan",
